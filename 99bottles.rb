def english_number number 
	...
	num_string = '' # This is the string we will return define it a start empty
	...
	# write is whichpart we are writing out at the time
	...
	if write > 0 
		...
		if write > 0
			...
			left = left - write*20 # subtract off those tens
